...
questions = {
    ...
    7: ["If 2(3x+4)=(4x+5)/3, what is x?","If (x/19)=4x-23, what is x?"],
    ...
    9: ["The sum of two numbers is 18, and the product of these two numbers is 56. What are the numbers?","Doug went to a conference in a city 120 km away. On the way back, due to road construction, he had to drive 10 km/h slower, which resulted in the return trip taking 2 hours longer.\nHow fast did he drive on the way to the conference?"],
